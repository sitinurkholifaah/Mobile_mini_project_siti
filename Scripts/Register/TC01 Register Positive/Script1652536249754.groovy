...
Mobile.setText(findTestObject('Register/android.widget.EditText -  Email'), 'sitinurkho@email.com', 0)

Mobile.tap(findTestObject('Register/android.widget.EditText - Password'), 0)

Mobile.setText(findTestObject('Register/android.widget.EditText - Password'), '123456789', 0)
