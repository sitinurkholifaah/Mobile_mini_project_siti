...
Mobile.setText(findTestObject('Register/android.widget.EditText -  Fullname'), 'siti nur kholifah', 0)

Mobile.tap(findTestObject('Register/android.widget.EditText -  Email'), 0)

Mobile.setText(findTestObject('Register/android.widget.EditText -  Email'), 'sitinurkh@email.com', 0)

Mobile.tap(findTestObject('Register/android.widget.EditText - Password'), 0)

Mobile.setText(findTestObject('Register/android.widget.EditText - Password'), '1234567890', 0)
