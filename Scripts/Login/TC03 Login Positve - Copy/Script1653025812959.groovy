...
Mobile.setText(findTestObject('Login/android.widget.EditText - Email'), 'sitinurk@email.com', 0)

Mobile.tap(findTestObject('Login/android.widget.EditText - Password'), 0)

Mobile.setText(findTestObject('Login/android.widget.EditText - Password'), '1234567890', 0)
